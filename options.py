...
def preprocess_setting():
    ...
    #parser.add_argument("-t", "--task_ids", default = "500")#nargs="+")
    ...
    parser.add_argument("--nnUNet_raw_data", default= '/data/1_nnunet_refactoring/nnUNet_raw_data_base/nnUNet_raw_data')#required=True)
