...
def main():
    ...
    dataset_directory = os.path.join(args.default_preprocessed_folder, args.task)

    # Load Plans File
    if args.network == '2d':
        plans_file = os.path.join(args.default_preprocessed_folder, args.task, args.plans_identifier + "_plans_2D.pkl")
    else:
        plans_file = os.path.join(args.default_preprocessed_folder, args.task, args.plans_identifier + "_plans_3D.pkl")
