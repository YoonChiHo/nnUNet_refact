...
import os
from batchgenerators.utilities.file_and_folder_operations import subfiles, subfolders
import shutil
...
from lib.utils import save_json, load_pickle
...
def load_model_and_checkpoint_files(folder, folds=None, mixed_precision=None, checkpoint_name="model_best"):
    ...
    info = load_pickle(os.path.join(folds[0], "%s.model.pkl" % checkpoint_name))
    init = info['init']
    trainer = nnUNetTrainer_simple(*init)
